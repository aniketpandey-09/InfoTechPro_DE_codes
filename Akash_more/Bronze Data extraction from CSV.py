...
customer_file_path = f"s3a://{bucket_name}/dbfs/FileStore/tables/sales_orders.csv"
...
customer_df = spark.read.format("csv").schema(customer_schema).load("/dbfs/FileStore/tables/sales_orders.csv")
